...
void vs1003_record_mode_init()
{
  ...
  write_register(SCI_MODE, 0x1804); // SM_RESET=1 SM_ADPCM_=1 SM_ADPCM_HP(500~3000)=0 SM_LINE_IN=1  MSb_first(sdi_msb_first)
  rt_thread_mdelay(1);
...
{
  rt_thread_t tid = rt_thread_create("recorder",
